...
import { UserFormFields, RealStateFormFields } from "../../libs/types";
...
export default function Profile() {
  ...
  if (status === "loading" || userRole === null)
    return <p>Cargando sesión y perfil...</p>;
  ...
  return (
    <div className="w-full mx-auto mt-40 p-4 bg-transparent">
      {message && (
        <p className="mb-4 p-3 bg-blue-100 border-l-4 border-blue-500 text-blue-700">
          {message}
        </p>
      )}
